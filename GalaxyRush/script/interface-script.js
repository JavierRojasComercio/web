...
function updateInterfaces() {
    ...
    var warpEngineOverheatingMeter = document.getElementById("jump-progress");
    ...
    var energyMeter2 = document.getElementById("energy-meter2");
    var energyMeter3 = document.getElementById("energy-meter3");
    var energyMeter4 = document.getElementById("energy-meter4");
    ...
    warpEngineOverheatingMeter.value = warpEngineOverheating;
    ...
    energyMeter2.value = getEnergy();
    energyMeter3.value = getEnergy();
    energyMeter4.value = getEnergy();
